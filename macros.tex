...
\newcommand{\stt}{\hspace{.5em} \text{s.t} \hspace{.5em}}
\newcommand{\aand}{\hspace{.5em} \text{and} \hspace{.5em}}
\newcommand{\comma}{\hspace{.5em}, \hspace{.5em}}
\newcommand{\for}{\hspace{.5em} \text{for} \hspace{.5em}}
\newcommand{\tif}{\hspace{.5em} \text{if} \hspace{.5em}}
\newcommand{\tor}{\hspace{.5em} \text{or} \hspace{.5em}}

\newcommand{\seq}[1]{\{#1_n\}_{1}^{\infty}}

\newcommand{\unif}[2]{\sim \text{Unif}(#1, #2)}
\newcommand{\normal}[2]{\sim \text{N}\left(#1, #2\right)}
\newcommand{\pois}[1]{\sim \text{Pois}(#1)}
\newcommand{\expo}[1]{\sim \text{Exp}(#1)}
...
\newcommand{\writer}{Pratim Chowdhary}
\newcommand{\email}{pratim.chowdhary.25@dartmouth.edu}
